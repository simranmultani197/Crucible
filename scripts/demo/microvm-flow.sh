...
echo "[crucible-demo] probing local_microvm runtime..."
npm run -s microvm:probe

SANDBOX_ID="crucible-demo-$(date +%s)"
...
echo "[crucible-demo] creating sandbox: ${SANDBOX_ID}"
node scripts/microvmctl.js create --id "${SANDBOX_ID}" --ttl-ms 180000

echo "[crucible-demo] writing demo program..."
...
payload = {
    ...
    "message": "Crucible local microVM demo completed",
}
